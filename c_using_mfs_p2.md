...
With the Professional 1 Application plan, users can create 1 mobile application with various mobile operating systems. After you create the {{site.data.keyword.mobilefoundation_short}}: Professional 1 Application service instance, read the following procedure to get started with the service.
...
* {{site.data.keyword.mobilefoundation_short}}: Professional 1 Application is supported only with {{site.data.keyword.Db2_on_Cloud_short}} or {{site.data.keyword.composeForPostgreSQL}} or Databases for {{site.data.keyword.postgresql}} {{site.data.keyword.cloud_notm}} plans.
...
1. Select the {{site.data.keyword.cloud_notm}} `Organization` where the {{site.data.keyword.Db2_on_Cloud_short}} service instance exists.
...
## Starting the {{site.data.keyword.mobilefoundation_short}} server that is created by using Professional 1 Application plan
...
## Re-creating the {{site.data.keyword.mfserver_short_notm}} server when you use Professional 1 Application plan
...
* From the **Topology** tab, you can select the server size and number of server instances based on your need. The default 1 GB server is enough for development and light testing.
   ...
   - **Instances** display the number of nodes that are created.

## {{site.data.keyword.mobileanalytics_short}} in Professional 1 Application plan
{: #mobile_analytics_p2}

{{site.data.keyword.mobileanalytics_short}} server is included and preconfigured with the {{site.data.keyword.mobilefoundation_short}} Professional 1 Application plan service instance.

* Launch the {{site.data.keyword.mobileanalytics_short}} Console from the {{site.data.keyword.mfp_oc_short_notm}}.

For more information on {{site.data.keyword.mobileanalytics_short}}, see [here](/docs/services/mobilefoundation?topic=mobilefoundation-instrument_your_app#instrument_your_app).
